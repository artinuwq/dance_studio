...
SETTING_SPECS: dict[str, SettingSpec] = {
    ...
    "tech.logs_chat_id": SettingSpec(
        key="tech.logs_chat_id",
        value_type="int",
        default=0,
        description="Telegram chat_id of technical service/logs group.",
        is_public=False,
        min_value=-10_000_000_000_000,
        max_value=10_000_000_000_000,
    ),
    "tech.backups_topic_id": SettingSpec(
        key="tech.backups_topic_id",
        value_type="int",
        default=0,
        description="Forum topic id for backup messages in technical chat.",
        is_public=False,
        min_value=0,
        max_value=2_147_483_647,
    ),
    "tech.status_topic_id": SettingSpec(
        key="tech.status_topic_id",
        value_type="int",
        default=0,
        description="Forum topic id for bot status messages in technical chat.",
        is_public=False,
        min_value=0,
        max_value=2_147_483_647,
    ),
    "tech.critical_topic_id": SettingSpec(
        key="tech.critical_topic_id",
        value_type="int",
        default=0,
        description="Forum topic id for critical alerts in technical chat.",
        is_public=False,
        min_value=0,
        max_value=2_147_483_647,
    ),
    "tech.notifications_topic_id": SettingSpec(
        key="tech.notifications_topic_id",
        value_type="int",
        default=0,
        description="Forum topic id for user-notification mirror messages in technical chat.",
        is_public=False,
        min_value=0,
        max_value=2_147_483_647,
    ),
    "tech.status_message_id": SettingSpec(
        key="tech.status_message_id",
        value_type="int",
        default=0,
        description="Pinned/live bot status message id in status forum topic.",
        is_public=False,
        min_value=0,
        max_value=2_147_483_647,
    ),
    "bookings.admin_chat_id": SettingSpec(
        key="bookings.admin_chat_id",
        value_type="int",
        default=0,
        description="Telegram chat_id where booking moderation notifications are sent.",
        is_public=False,
        min_value=-10_000_000_000_000,
        max_value=10_000_000_000_000,
    ),
