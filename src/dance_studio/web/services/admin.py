...
def _serialize_client_abonement_for_admin(db, abonement: GroupAbonement) -> dict:
    ...
    return {
        ...
        "price_total_rub": getattr(abonement, "price_total_rub", None),
        "lessons_total": getattr(abonement, "lessons_total", None),
        "price_per_lesson_rub": getattr(abonement, "price_per_lesson_rub", None),
