...
class GroupAbonement(Base):
    ...
    price_total_rub = Column(Integer, nullable=True)
    lessons_total = Column(Integer, nullable=True)
    price_per_lesson_rub = Column(Integer, nullable=True)
...
class Attendance(Base):
    ...
    lesson_price_rub = Column(Integer, nullable=True)
    teacher_percent = Column(Integer, nullable=True)
    teacher_payout_rub = Column(Integer, nullable=True)
